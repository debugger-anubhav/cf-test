...
export const AnnexureData = [
  {
    ...
    points: [
      `Minor scratches (below 1mm in width and depth, and 2cm in length) on wooden furniture shall be ignored as they are considered 'normal wear and tear'.`,
      `Minor chips and breakage in timber (below 5mm in width, 1mm in depth and 1cm in length) shall be ignored, while those above the said dimensions shall be charged for.`,
      `Any damage which is a result of raw material or manufacturing defects shall not be chargeable.`,
      `Any damage that results in the product being unusable shall result in the value of the product being charged to the subscriber.`,
      `Any damage that results in the replaceable part of the product being unusable shall result in the value of the part being charged to the subscriber.`,
      `Tear in upholstery shall result in charge towards replacement of upholstery. Opening up of a stitched joint shall not be chargeable.`,
      `Stains on upholstery which are not removable via dry cleaning shall result in a charge for upholstery replacement.`,
    ],
  },
];
