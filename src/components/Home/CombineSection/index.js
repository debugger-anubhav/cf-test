...
const CombineSection = () => {
  return (
    <div className=" pb-20 pt-12  w-full flex px-[70px] xl:px-[90px]  macbook:px-[122px] 3xl:px-[160px] gap-4  md:flex-row flex-col">
      {/* for desktop */}
      ...
      <div className="2xl:w-[40%] md:w-[50%] w-full flex ">
        <PartnershipBanner />
      </div>
